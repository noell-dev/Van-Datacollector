...
if __name__ == "__main__":
    ...
    btn1 = Button(name=button.name, text=button.description, command=lambda: pressButton(serial=ser, number=1), bg="#DC0F16", width=20, height=10, master=button_frame, highlightBackground=None)
    btn1.pack(side=BOTTOM)
    serial_buttons[button.name] = btn1

    button = buttons["out2_hi"]
    btn2 = Button(name=button.name, text=button.description, command=lambda: pressButton(serial=ser, number=2), bg="#DC0F16", width=20, height=10, master=button_frame, highlightbackground=None)
    btn2.pack(side=BOTTOM)
    serial_buttons[button.name] = btn2

    button = buttons["out3_hi"]
    btn3 = Button(name=button.name, text=button.description, command=lambda: pressButton(serial=ser, number=3), bg="#DC0F16", width=20, height=5, master=button_frame, activeBackground=None)
